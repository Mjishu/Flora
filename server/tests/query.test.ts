...
const mockDate = new Date("2024-09-21T23:00:00Z");
...
test("computed time is correct", () => {
    expect(rows[0].computed_time <= new Date("2024-09-21T04:00:00.000Z")).toBe(true) //* if this passes then The ^^ test should also pass? 
})
